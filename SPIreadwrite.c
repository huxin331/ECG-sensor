...
uint8_t SPIReadReg(uint8_t addr)
{
	...
	// SEGGER_RTT_printf(0, " t value is %x\n", temp[0]);
...
int main(void)
{
      unsigned char reg = 0x01; //IC Identity Register
      nrf_gpio_cfg_output(30); //for the CS pin
	    nrf_gpio_cfg_output(31); //for the start pin
	    nrf_gpio_cfg_output(3); //for the reset pin
